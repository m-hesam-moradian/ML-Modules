...
def K_Fold(X, y, n_splits=5):
    ...
    etr_X_train_best, etr_X_test_best, etr_y_train_best, etr_y_test_best = (
        get_best_fold_data_from_kf(X, y, etr_scores, kf)
    )
    lasso_X_train_best, lasso_X_test_best, lasso_y_train_best, lasso_y_test_best = (
        get_best_fold_data_from_kf(X, y, lasso_scores, kf)
    )
    ...
    if (
        etr_X_train_best.equals(lasso_X_train_best)
        and etr_X_test_best.equals(lasso_X_test_best)
        and etr_y_train_best.equals(lasso_y_train_best)
        and etr_y_test_best.equals(lasso_y_test_best)
    ):
